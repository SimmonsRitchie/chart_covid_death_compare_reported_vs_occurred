      ...
      <div className="container__outer">
        <div className="container__inner">
          ...
          <Footer 
            ...
            source="Reported death data is based on statistics reported on the website of the Pa. Department of Health and collected daily by Spotlight PA/the Philadelphia Inquirer between March to June, 2020. Occurred death data is based on Pa. Department of Health statistics collated on June 16, 2020."
            outlet="Spotlight PA"
